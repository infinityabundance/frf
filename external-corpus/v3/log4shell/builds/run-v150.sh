#!/bin/sh
# The Log4Shell launcher — the 2.15.0 jar set (Log4j 2.15.0: message
# lookups disabled by default — the CVE-2021-44228 mitigation point).
...
exec java \
  ...
  -Xss512k \
  -XX:-UsePerfData \
  -cp "builds/probe.jar:builds/lib/log4j-api-2.15.0.jar:builds/lib/log4j-core-2.15.0.jar" \
  Log4ShellProbe "$1"
