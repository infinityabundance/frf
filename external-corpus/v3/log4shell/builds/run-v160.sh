#!/bin/sh
# The Log4Shell launcher — the 2.16.0 jar set (Log4j 2.16.0: JNDI lookup
# support removed entirely — CVE-2021-44832 hardening).
...
exec java \
  ...
  -Xss512k \
  -XX:-UsePerfData \
  -cp "builds/probe.jar:builds/lib/log4j-api-2.16.0.jar:builds/lib/log4j-core-2.16.0.jar" \
  Log4ShellProbe "$1"
