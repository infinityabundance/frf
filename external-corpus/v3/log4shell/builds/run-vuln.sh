...
exec java -XX:CompressedClassSpaceSize=64m -Xmx256m -cp "builds/probe.jar:builds/lib/log4j-api-2.14.1.jar:builds/lib/log4j-core-2.14.1.jar" Log4ShellProbe "$1"
